...
static void ProfessionalStandards(EducationalProgram program) {
...
do {
    ...
    Console.WriteLine("Информация о проф. стандартах - 1");
    Console.WriteLine("Введите код компетенции - 2");
    Console.WriteLine("Введите индекс дисциплины - 3");
    Console.WriteLine("Введите номер семестра - 4");
    Console.WriteLine("Введите номер курса - 5");
    Console.WriteLine("Остановить программу программу - 6");
    cmd = Input("Введите команду: ");

    switch (cmd){
        case "1":
            ProfessionalStandards(program);
            break;
        case "2":
